...
[source,scala]
----  
include::../../modules/client-scala/src/main/scala/be/wegenenverkeer/atomium/client/FeedProvider.scala[tags=adoc]
----
...
[source,scala]
----
include::../../modules/client-scala/src/main/scala/be/wegenenverkeer/atomium/client/async/AsyncFeedProvider.scala[tags=adoc]
----
...
----
libraryDependencies += "be.wegenenverkeer" %% "atomium-client-scala" % "{project-version}"
----
...
.Declaring the dependency in a SBT build file (i.e., build.sbt)
----
libraryDependencies += "be.wegenenverkeer" %% "atomium-server-jdbc" % "{project-version}"
----
...
.Declaring the dependency in a SBT build file (i.e., build.sbt)
----
libraryDependencies += "be.wegenenverkeer" %% "atomium-server-slick" % "{project-version}"
----
...
.Declaring the dependency in a SBT build file (i.e., build.sbt)
----
libraryDependencies += "be.wegenenverkeer" %% "atomium-server-mongo" % "{project-version}"
----
...
.Declaring the dependency in a SBT build file (i.e., build.sbt)
----
libraryDependencies += "be.wegenenverkeer" %% "atomium-server-play" % "{project-version}"
----
