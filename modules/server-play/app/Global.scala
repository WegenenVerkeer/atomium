...
object Global extends WithFilters(new GzipFilter()) with GlobalSettings {
  ...
  val id = "my_feed"
  val stringStore: FeedStore[String] = new MemoryFeedStore[String](id, Url("http://localhost:9000/feeds/"), Some("strings of life"))
  ...
  val eventStore: FeedStore[Event] = new MemoryFeedStore[Event](events_id, Url("http://localhost:9000/feeds/"), Some("events"), "application/xml")
