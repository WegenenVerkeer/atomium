...
public interface RetryStrategy {
     ...
     * feed page. If the exception is re-thrown the Observable will </p> emit an Error with this exception.</p>
     ...
     * @throws Throwable exception specified by current exception parameter
     */
