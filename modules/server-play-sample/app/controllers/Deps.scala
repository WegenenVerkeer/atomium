...
object Deps {
  ...
  lazy val stringService : FeedService[String, Context] = {
    val id = "my_feed"
    val stringStore = new MemoryFeedStore[String, Context](id, new Url(s"http://localhost:9000/feeds/$id/"), Some("strings of life"), "text/plain")
  ...
  lazy val eventService : FeedService[Event,Context] = {
    ...
    val eventStore = new MemoryFeedStore[Event, Context](events_id, new Url(s"http://localhost:9000/feeds/$events_id/"), Some("events"), "application/xml")
